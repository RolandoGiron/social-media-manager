...
Plans:
- [x] 04-01-PLAN.md — Database migration (knowledge_base table), KB CRUD functions, inbox query functions, appointment insert, test scaffolds
- [x] 04-02-PLAN.md — Streamlit Inbox page and Knowledge Base page with navigation wiring
...
Plans:
- [ ] 05-01-PLAN.md — Campaign DB helper functions (TDD: fetch/insert/cancel/history) + test scaffolds
- [ ] 05-02-PLAN.md — Streamlit 7_Campañas.py page: setup, confirmation gate, progress view, history table + nav wiring
- [ ] 05-03-PLAN.md — n8n campaign-blast workflow: webhook trigger, recipient loop, jitter, cancellation, Evolution API send
**UI hint**: yes
...
Plans:
- [ ] 06-01-PLAN.md — social_posts DB helpers + image upload module + tests (foundation)
- [ ] 06-02-PLAN.md — Docker uploads volume + Caddy static route + n8n social-publish workflow (mock + real)
- [ ] 06-03-PLAN.md — 8_Publicaciones.py standalone page + 7_Campañas.py Step 3 unified launch + human verification
**UI hint**: yes
...
| 4. AI Chatbot + Appointment Booking | 2/4 | In Progress|  |
| 5. Campaign Blast | 0/? | Not started | - |
| 6. Social Media Publishing | 0/3 | Planning complete | - |
