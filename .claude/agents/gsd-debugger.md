...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/rolando/Desarrollo/social-media-manager/.claude
                  → checks /home/rolando/Desarrollo/social-media-manager/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/rolando/Desarrollo/social-media-manager/.claude/get-shit-done
                  → writes to /home/rolando/Desarrollo/social-media-manager/.claude/get-shit-done/hooks/
...
@/home/rolando/Desarrollo/social-media-manager/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/rolando/Desarrollo/social-media-manager/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/rolando/Desarrollo/social-media-manager/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/rolando/Desarrollo/social-media-manager/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/rolando/Desarrollo/social-media-manager/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
