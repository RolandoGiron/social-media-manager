...
<reference>
@/home/rolando/Desarrollo/social-media-manager/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/rolando/Desarrollo/social-media-manager/.claude/get-shit-done/references/user-profiling.md` to load:
