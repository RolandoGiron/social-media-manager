...
- Usage: Reference from command with `@/home/rolando/Desarrollo/social-media-manager/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/rolando/Desarrollo/social-media-manager/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/rolando/Desarrollo/social-media-manager/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
