...
- **Global scope**: `/home/rolando/Desarrollo/social-media-manager/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/rolando/Desarrollo/social-media-manager/.claude/notes/`)
...
2. Glob `/home/rolando/Desarrollo/social-media-manager/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/rolando/Desarrollo/social-media-manager/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/rolando/Desarrollo/social-media-manager/.claude/notes/` — works in any directory
